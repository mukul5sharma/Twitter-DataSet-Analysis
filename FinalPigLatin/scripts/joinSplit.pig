...
STORE characterCentral INTO 's3://mrprojectsarika/outputSplit/central' USING PigStorage(',');
STORE characterEast INTO 's3://mrprojectsarika/outputSplit/east' USING PigStorage(',');
STORE characterMountain INTO 's3://mrprojectsarika/outputSplit/mountain' USING PigStorage(',');
STORE characterPacific INTO 's3://mrprojectsarika/outputSplit/pacific' USING PigStorage(',');
